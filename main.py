...
parser.add_argument('--datadir', default='../residual_adapters/decathlon-1.0/', help='folder containing data folder')
parser.add_argument('--imdbdir', default='../residual_adapters/decathlon-1.0/annotations/', help='annotation folder')
parser.add_argument('--ckpdir', default='./pointwise_sharing/', help='folder saving checkpoint')
...
parser.add_argument('--step3', default=80, type=int, help='nb epochs before first lr decrease')

args = parser.parse_args()

dropout_list = ['gtsrb', 'ucf101', 'daimlerpedcls']
...
for i, dataset in enumerate(datasets.keys()):
    ...
    net = get_model("Resnet26", num_class, dataset = "imagenet12", mode = 'train', dropout_list=dropout_list)
